...
This script only accepts bipartite graphs as input.
"""
...
if __name__ == "__main__":
    # Example: Create small bipartite graphs and count subforests
    ...
    count1, subforests1 = count_subforests_bipartite(G1)
    ...
    count2 = count_subforests_bipartite_fast(G2)
    ...
    count3 = count_subforests_bipartite_fast(G3)
    ...
    count4 = count_subforests_bipartite_fast(G4)
    ...
    try:
        count5 = count_subforests_bipartite_fast(G5)
